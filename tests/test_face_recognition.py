...
class Test_face_recognition(unittest.TestCase):
    def test_load_image_file(self):
        img = api.load_image_file(  # pyright: ignore[reportUnknownMemberType]
            os.path.join(
                os.path.dirname(
                    __file__,
                ),
    ...
    def test_raw_face_locations(self):
        ...
        detected_faces = api._raw_face_locations(  # pyright: ignore[reportUnknownMemberType,reportUnknownVariableType]
            img,
        )

        self.assertEqual(
            len(
                detected_faces,  # pyright: ignore[reportUnknownArgumentType]
            ),
            1,
        )
        self.assertEqual(
            detected_faces[0].top(),  # pyright: ignore[reportUnknownMemberType]
            142,
        )
        self.assertEqual(
            detected_faces[0].bottom(),  # pyright: ignore[reportUnknownMemberType]
            409,
        )
    ...
    def test_cnn_raw_face_locations(self):
        ...
        self.assertAlmostEqual(
            detected_faces[  # pyright: ignore[reportUnknownArgumentType,reportUnknownMemberType]
                0
            ].rect.top(),
            144,
            delta=25,
    ...
    def test_face_locations(self):
        ...
        detected_faces = api.face_locations(  # pyright: ignore[reportUnknownMemberType,reportUnknownVariableType]
            img,
        )
    ...
    def test_cnn_face_locations(self):
        ...
        self.assertAlmostEqual(
            detected_faces[0][1],  # pyright: ignore[reportUnknownArgumentType]
            608,
            delta=25,
        )
        self.assertAlmostEqual(
            detected_faces[0][2],  # pyright: ignore[reportUnknownArgumentType]
            389,
            delta=25,
        )
    ...
    def test_raw_face_locations_batched(self):
        ...
        images = [img, img, img]
        batched_detected_faces = api._raw_face_locations_batched(  # pyright: ignore[reportUnknownMemberType,reportUnknownVariableType]
            images,
        ...
        for (
            detected_faces
        ) in batched_detected_faces:  # pyright: ignore[reportUnknownVariableType]
            self.assertEqual(
                len(
                    detected_faces,  # pyright: ignore[reportUnknownArgumentType]
                ),
            ...
            self.assertEqual(
                detected_faces[  # pyright: ignore[reportUnknownMemberType]
                    0
                ].rect.top(),
                154,
            )
    ...
    def test_batched_face_locations(self):
        ...
        batched_detected_faces = api.batch_face_locations(  # pyright: ignore[reportUnknownMemberType,reportUnknownVariableType]
            images,
            number_of_times_to_upsample=0,
        )
    ...
    def test_raw_face_landmarks(self):
        ...
        face_landmarks = api._raw_face_landmarks(  # pyright: ignore[reportUnknownMemberType,reportUnknownVariableType]
            img,
        )
        example_landmark = face_landmarks[  # pyright: ignore[reportUnknownMemberType,reportUnknownVariableType]
            0
        ].parts()[
            10
        ]
        ...
        self.assertEqual(
            len(
                face_landmarks,  # pyright: ignore[reportUnknownArgumentType]
            ),
            1,
        )
        self.assertEqual(
            face_landmarks[0].num_parts,  # pyright: ignore[reportUnknownMemberType]
            68,
        )
        self.assertEqual(
            (
                example_landmark.x,  # pyright: ignore[reportUnknownMemberType]
                example_landmark.y,  # pyright: ignore[reportUnknownMemberType]
            ),
            (
                552,
                399,
    ...
    def test_face_landmarks(self):
        ...
        face_landmarks = api.face_landmarks(  # pyright: ignore[reportUnknownMemberType,reportUnknownVariableType]
            img,
        )

        self.assertEqual(
            set(
                face_landmarks[0].keys(),  # pyright: ignore[reportUnknownArgumentType]
            ),
            set(
                [
                    "chin",
    ...
    def test_face_encodings(self):
        ...
        encodings = api.face_encodings(  # pyright: ignore[reportUnknownMemberType,reportUnknownVariableType]
            img,
        )
        ...
        self.assertEqual(
            len(
                encodings[0],  # pyright: ignore[reportUnknownArgumentType]
            ),
            128,
        )
    ...
    def test_face_distance(self):
        img_a1 = api.load_image_file(  # pyright: ignore[reportUnknownMemberType]
            os.path.join(
                os.path.dirname(
                    __file__,
                ),
        ...
        img_a2 = api.load_image_file(  # pyright: ignore[reportUnknownMemberType]
            os.path.join(
                os.path.dirname(
                    __file__,
                ),
        ...
        img_a3 = api.load_image_file(  # pyright: ignore[reportUnknownMemberType]
            os.path.join(
                os.path.dirname(
                    __file__,
                ),
        ...
        img_b1 = api.load_image_file(  # pyright: ignore[reportUnknownMemberType]
            os.path.join(
                os.path.dirname(
                    __file__,
                ),
        ...
        face_encoding_a1 = api.face_encodings(  # pyright: ignore[reportUnknownMemberType,reportUnknownVariableType]
            img_a1,
        )[
            0
        ]
        face_encoding_a2 = api.face_encodings(  # pyright: ignore[reportUnknownMemberType,reportUnknownVariableType]
            img_a2,
        )[
            0
        ]
        face_encoding_a3 = api.face_encodings(  # pyright: ignore[reportUnknownMemberType,reportUnknownVariableType]
            img_a3,
        )[
            0
        ]
        face_encoding_b1 = api.face_encodings(  # pyright: ignore[reportUnknownMemberType,reportUnknownVariableType]
            img_b1,
        )[
            0
        ]

        faces_to_compare = [  # pyright: ignore[reportUnknownVariableType]
            face_encoding_a2,
            face_encoding_a3,
            face_encoding_b1,
        ]
        ...
        distance_results = (
            api.face_distance(  # pyright: ignore[reportUnknownMemberType]
                faces_to_compare,
                face_encoding_a1,
            )
        )
    ...
    def test_face_distance_empty_lists(self):
        ...
        face_encoding = api.face_encodings(  # pyright: ignore[reportUnknownMemberType,reportUnknownVariableType]
            img,
        )[
            0
        ]
        ...
        # empty numpy list
        faces_to_compare = np.array([]) # pyright: ignore[reportUnknownArgumentType, reportUnknownVariableType]
    ...
    def test_compare_faces(self):
        ...
        match_results = api.compare_faces(  # pyright: ignore[reportUnknownMemberType]
            faces_to_compare,
            face_encoding_a1,
        )
    ...
    def test_command_line_interface_options(self):
        ...
        runner = CliRunner()
        help_result = runner.invoke(  # pyright: ignore[reportUnknownMemberType]
