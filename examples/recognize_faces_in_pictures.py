...
try:
    ...
    unknown_face_encoding = face_recognition.face_encodings(  # pyright: ignore[reportUnknownMemberType,reportUnknownVariableType]
        unknown_image,
    )[
        0
    ]
...
results = face_recognition.compare_faces(  # pyright: ignore[reportUnknownMemberType]
    known_faces,
