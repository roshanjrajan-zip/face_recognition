...
def predict(  # pyright: ignore[reportUnknownParameterType]
    X_img_path,  # pyright: ignore[reportMissingParameterType,reportUnknownParameterType]
    ...
    distance_threshold=0.6,  # pyright: ignore[reportMissingParameterType]
):
    """
    ...
    if (
        not os.path.isfile(
            X_img_path,  # pyright: ignore[reportUnknownArgumentType]
        )
        or os.path.splitext(
            X_img_path,  # pyright: ignore[reportUnknownArgumentType]
        )[
...
def show_prediction_labels_on_image(
    img_path,  # pyright: ignore[reportMissingParameterType,reportUnknownParameterType]
