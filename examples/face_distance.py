...
known_encodings = [  # pyright: ignore[reportUnknownVariableType]
    obama_face_encoding,
    biden_face_encoding,
]
...
image_to_test_encoding = face_recognition.face_encodings(  # pyright: ignore[reportUnknownMemberType,reportUnknownVariableType]
    image_to_test,
)[
    0
]
